  ...
  return (
    <div className='max-w-screen-2xl mx-auto h-auto'>
        <div className='w-full bg-white shadow-md'>
          <div className=' md:flex justify-between px-10  my-10  h-14 box-border bg-yellow-50 shadow-md border-s-orange-100'>
            <div>
       ...
       <div className="flex-grow flex flex-wrap px-8 md:pr-20 -mb-10 md:text-left text-center order-first">
